...
//		password := u.Password
//
//		signatureKey, err := h.srv.Server().CreateSignatureKey(ctx)
//		if err != nil {
//			trans := i18n.New()
//			return echo.NewHTTPError(
//				http.StatusBadRequest,
//				validators.Error{
//					Message: trans.Trans(ctx, "The encryption key is already in use"),
...
//		return e.JSON(http.StatusCreated, &Response{Key: signatureKey, Username: username, Email: email})
//	}
//}
//
